...
class SetProperty:
    ...
    def __init__(self, name, binary_read):
        ...
        if self.subtype == "StructProperty":
            ...
            self.value = [] #[binary_read.read_property() for _ in range(content_count)]
        ...
        logger.debug(f'Position:{binary_read.offset}, {self.name}, {self.type}, {self.subtype}, {self.value}')
