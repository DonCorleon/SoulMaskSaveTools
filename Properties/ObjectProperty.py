...
class ObjectProperty:
    ...
    def __init__(self, name, binary_read, in_array=False, object_list=False):
        ...
        logger.error(f'{text_colours["Blue"]}ObjectProperty name:position:{binary_read.offset}, name:{self.name}, type:{self.type}, in_array:{in_array}, object_list:{object_list}')
        ...
        if not in_array:
            ...
            logger.info(f'{text_colours["Blue"]}ObjectProperty name:{self.name}, type:{object_types[self.object_type]} content_size:{content_size}, position:{binary_read.offset}')
        ...
        logger.debug(f'{text_colours["Blue"]}Object Complete:{self.name}, {self.object_type}, {self.value}')
